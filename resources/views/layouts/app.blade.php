                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a href="admission.html" class="nav-link">College of Arts and Education </a></li>
                                            <li class="nav-item"><a href="how-to-apply.html" class="nav-link">College of Basic Medical and Health Sciences </a></li>
                                            <li class="nav-item"><a href="tuition-fees.html" class="nav-link">College of Natural and Applied Sciences</a></li>
                                            <li class="nav-item"><a href="financial-aid.html" class="nav-link">College of Management and Social Sciences</a></li>
                                            <li class="nav-item"><a href="date-deadlines.html" class="nav-link">College of Law</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
