                    ...
                    <div class="ac-overview">
                        <div class="pera-dec">
                            ...
                            <div class="number-list">
                                <a href="{{ URL::to('public/resources/appointment-of-vc.pdf') }}"><img
                                        src="{{ asset('img/icon/pdf.jpg') }}" class="img-res" style="width: 7%"
                                        alt=""></a>
                            </div>
                            ...
                            <div class="program-points mt-4">
                                <div class="single-point-list">
                                    ...
                                    <p>The Academic Planning and Quality Assurance Unit sincerely appreciates the
                                        Proprietor, Board of Trustees, Council, the Vice-Chancellor, the Registrar, the
                                        Acting University Librarian, the University Bursar, Deans of Colleges/Schools, Heads
                                        & Coordinators of Departments, Directors/Coordinators of Departments/Units and
                                        Centres and the entire university community for their usual cooperation and support.
                                    </p>
                                    <a class="btn btn-success"
                                        href="{{ URL::to('public/resources/Annual-Report-Fountain-2019-2021.pdf') }}"> Click
                                        here to Download </a>
                                </div>
                                <div class="single-point-list mt-4">
                                    ...
                                    <a class="btn btn-success"
                                        href="{{ URL::to('public/resources/2018-2019-Annual-Report-FU-1-1.pdf') }}"> Click
                                        here to Download </a>
                                </div>
                            </div>
                        </div>
