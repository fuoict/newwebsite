        ...
        <div class="offcanvas-body">
            ...
            <div class="offcanvas-contact-info">
                ...
                <ul class="contact-info list-style">
                    ...
                    <li><i class="bx bxs-phone-call"></i> General Inquiries - <a href="tel:+8495160885">(849) 516-0885</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="banner-spacing">
                <div class="section-info">
                    ...
                    <p data-aos="fade-up" data-aos-delay="200">Fountain University is more than just a place of learning;
                        it's a place where dreams take flight, where ideas flourish, and where you'll find the support and
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6">
                            <div class="notice-content" data-aos="fade-right" data-aos-delay="200">
                                <p class="title-anim" style="text-align: justify;">
                                    ...
                                    University was borne out of its educational policy and plan enunciated at its strategic
                                    Retreat held at Akodo, Lagos, in the year 2000. From this humble beginning, the Society
                                    started a systematic process which led to the hosting of an academic summit of 30
                                    Distinguished Academic Personalities from where an 18-person University Planning
                                    Committee emerged in January 2004.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6">
                            <div class="notice-content" data-aos="fade-right" data-aos-delay="200">
                                <i class='bx bxs-quote-left'></i>
                                <h4 class="title-anim">Philosophy</h4>
                                <p class="title-anim" style="text-align: justify;">
                                    Our philosophy is rooted in a commitment to excellence, intellectual
                                    curiosity, and the pursuit of knowledge. We strive to create a dynamic academic
                                    environment that fosters critical thinking, encourages creativity, and empowers
                                    individuals to make a positive impact on society.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-0 align-items-center flex-column-reverse flex-lg-row">
                <div class="col-lg-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p style="text-align: justify;">
                            At Fountain University, we are anchored by a set of enduring principles that define who we are, inspire what we do, and shape the future we seek to build. These guiding principles reflect our unwavering commitment to academic excellence, ethical leadership, innovation, and selfless service. They inform every aspect of our teaching, research, community engagement, and institutional governance, fostering a culture of integrity, responsibility, and lifelong learning. As the foundation of our identity, they guide our relationships with students, staff, alumni, 
                            partners, and the wider society, ensuring that we remain steadfast 
                            in our mission of producing competent, morally upright, and globally competitive graduates.
                        </p>
            ...
            <div class="row g-0 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p style="text-align: justify;">
                            A tour around Fountain University Campus gives you a splendid experience that always want you to
                            feature as a student. Our buildings are furnished with essential and basic facilities which
                            enhance a conducive learning environment. Our campus is endowed with recreational facilities and
                            natural spaces and essential medical facilities that encourage a healthy lifestyle outside the
                            classroom. Fountain University Campus is a place our students are proud to call a home during
                            their stay in the campus.</p>
                    </div>
                </div>
            </div>
            <div class="row g-0 align-items-center flex-column-reverse flex-lg-row">
    ...
    <div class="subscribe-area ptb-100">
        <div class="container">
            <div class="section-title" data-aos="fade-up" data-aos-delay="100">
                <div class="sub-title">
                    <i class='bx bxs-graduation'></i>
                    <p>Stay Connected with Fountain University</p>
                </div>
